...
const LoginForm = ({ onLoginSuccess, darkMode, setDarkMode }) => {
  ...
  return (
    <div className="min-h-screen font-sans bg-gray-100 dark:bg-gray-900">
      {/* Header */}
    <header className="flex items-center justify-between bg-gray-200 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-6 py-4">
  <span className="text-gray-800 dark:text-white text-lg font-medium">Login</span>

  <button
    onClick={() => setDarkMode(!darkMode)}
    className="px-4 py-2 bg-gray-300 dark:bg-gray-700 text-sm rounded-md transition hover:scale-105"
  >
    {darkMode ? "☀ Light Mode" : "🌙 Dark Mode"}
  </button>
</header>

      <div className="flex flex-wrap justify-center items-center h-[calc(100vh-64px)]">
        {/* Left Side - Illustration */}
        <div className="flex justify-center items-center bg-white dark:bg-gray-800 max-w-[600px] min-w-[400px] p-10 flex-1 transition-all duration-500">
